...
class IntegracaoServiceTest {
    ...
    void getIntegracaoById_deveRetornarIntegracaoQuandoExiste() {
        ...
        Optional<Integracao> resultado = integracaoService.buscaIntegracaoPorId(id);
    ...
    void deleteById_deveExcluirIntegracaoQuandoExiste() {
        ...
        integracaoService.excluirIntegracao(id);
    ...
    @Test
    @DisplayName("Dado que não exista uma integração com o ID informado, então deve lançar NaoEncontradoException")
    void atualizaIntegracao_deveLancarExcecaoQuandoNaoExiste() {
        UUID id = UUID.randomUUID();
        when(integracaoRepository.findById(id)).thenReturn(Optional.empty());

        assertThrows(NaoEncontradoException.class, () -> {
            integracaoService.atualizaIntegracao(id, new Integracao());
        });
